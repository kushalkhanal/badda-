 ...
 * @author amrit
 */
public class CustSupplier extends javax.swing.JFrame {
Connection con;
...
tabl();
    ...
    private void initComponents() {
        ...
        CPh1 = new javax.swing.JScrollPane();
        ...
        custable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Type", "Email", "Phone", "Mobile", "Address"
            }
        ));
                            ...
                            .addGroup(Body_PanelLayout.createSequentialGroup()
                                .addGroup(Body_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, Body_PanelLayout.createSequentialGroup()
                                        ...
                                        .addGroup(Body_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            .addComponent(CPh, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 197, Short.MAX_VALUE)
                                        ...
                                        .addGroup(Body_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(CPh1)
                                            .addGroup(Body_PanelLayout.createSequentialGroup()
                                                .addComponent(dsv, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(Body_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(Body_PanelLayout.createSequentialGroup()
                                .addGroup(Body_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(Body_PanelLayout.createSequentialGroup()
                                        .addGroup(Body_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(dsv, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(jScrollPane6, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(jLabel4)
                                            .addComponent(jLabel2))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(Body_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(CPh1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(Body_Panel, javax.swing.GroupLayout.PREFERRED_SIZE, 682, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
...
CustSupplier solld=new CustSupplier();
...
CustSupplier fa=new CustSupplier();
fa.setVisible(true);
this.dispose();
    }//GEN-LAST:event_ProductActionPerformed

    private void CustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CustomerActionPerformed
CustSupplier faa=new CustSupplier();
faa.setVisible(true);
this.dispose();
    ...
    private void dlt_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dlt_buttonActionPerformed
        ...
        String sql = "DELETE FROM `custsupplier` WHERE CustSupplierID ="+ch;
        try {
            ps=con.prepareStatement(sql);
            ps.execute();
    ...
    private void add_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_buttonActionPerformed
        try {
            ...
            +"(CName, CType, CEmail, CPhone, CMobile, CAddress)"
            +"values (?,?,?,?,?,?)";
            ps = con.prepareStatement(sql);
            ...
            ps.setString(5, CMobile.getText());
            ps.setString(6, CAddress.getText());
            ps.execute();
        ...
        new CustSupplier().setVisible(true);
        this.dispose();
...
this.dispose();
   ...
   public static void main(String args[]) {
    ...
    private javax.swing.JScrollPane CPh;
    private javax.swing.JScrollPane CPh1;
    ...
    private javax.swing.JScrollPane dsv;

...
setLocation(size.width/2-getWidth()/2,size.height/2-getHeight()/2);
    ...
    private void initComponents() {
        ...
        Welcome_Text.setText("Welcome to Login!");
        ...
        jScrollPane2.setViewportView(UserPassword);
        ...
        jLabel3.setText("Don't have an account? Please Sign Up!");
...
this.dispose();
  ...
  try{
    ...
    rs=ps.executeQuery();
      if(rs.next()){
          JOptionPane.showMessageDialog(null,"Welcome" + UserEmail.getText(),"Successful Login", JOptionPane.PLAIN_MESSAGE);
          new CustSupplier().setVisible(true);
          this.dispose();
      }else{
          JOptionPane.showMessageDialog(null,"Invalid Email/Password","Unsuccessful Login", JOptionPane.ERROR_MESSAGE);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        UserRegistration cocow=new UserRegistration();
        cocow.setVisible(true);
        this.dispose();        // TODO add your handling code here:
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        UserLogin coww=new UserLogin();

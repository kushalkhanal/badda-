...
tabl();
    ...
    private void initComponents() {
        ...
        jScrollPane3.setViewportView(UnitID);

        jLabel3.setText("Product Rate:");

        jScrollPane4.setViewportView(Rate);
        ...
        custable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Product Name", "Unit ID", "Rate", "Quantity"
            }
        ));

 ...
 * @author amrit
 */
public class PurchaseReports extends javax.swing.JFrame {
...
tabl();
    ...
    private void initComponents() {
        ...
        Welcome_Text.setText("Purchase Report:");
...
PurchaseReports akq=new PurchaseReports();
akq.setVisible(true);
this.dispose();
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PurchaseReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PurchaseReports().setVisible(true);
            }
        });
    }

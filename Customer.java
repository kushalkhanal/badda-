...
tabl();
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(customer_name);
        ...
        jScrollPane4.setViewportView(customer_email);
...
this.dispose();
    ...
    private void add_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_buttonActionPerformed
        try {
            ...
            ps.setString(3, customer_email.getText());
    ps.execute();
...
int row=custable.getSelectedRow();
       ...
       String sql = "DELETE FROM `customers` WHERE customer_id ="+ch;
       try {
           ps=con.prepareStatement(sql);
           ps.execute();
